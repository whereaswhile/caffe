...
MDL_DEF_FILE = fullfile(CAFFE_PATH, 'models/bvlc_reference_caffenet/deploy.prototxt');
MDL_WGH_FILE = fullfile(CAFFE_PATH, 'models/bvlc_reference_caffenet/bvlc_reference_caffenet.caffemodel');
